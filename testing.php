...
<div class="container">
  <h3 class="text-center pt-2">Testing Module</h3>
  ...
  if(isset($_POST['submit'])){
	...
	if($img1total<=2 || $img2total<=2){
		...
		mkdir("testing/".$lbl2."/");
		//mkdir("images/".$lbl2);
		$target_dir1="testing/".$lbl1."/";
		$target_dir2="testing/".$lbl2."/";
...
<input type="text" placeholder="Enter Label" name="lbl1" value="criminal" readonly >
<br><br>
 <label for="file-upload" class="custom-file-upload">
    <i class="fa fa-cloud-upload"></i> Custom Upload
</label>
<input id="file-upload" name="img2[]" type="file" multiple accept="image/jpeg" />
<input type="text" name="lbl2" placeholder="Enter Label" value="not criminal" readonly>
<br><br>
<input type="submit" class="btn btn-success" value="Upload" name="submit">
<a class="btn btn-success" href="test1.php">Test</a>
</form>
