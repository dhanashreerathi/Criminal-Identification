...
<head>
    ...
    <title>Criminal Identification</title>
                    ...
                    <div class="col-md-9 register-right">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                <h3 class="register-heading"> Covid Detection <br>Sign In</h3>
                            ...
                            <div class="tab-pane fade show" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                             <h3  class="register-heading">Covid Detection <br> Sign Up</h3>
                              <form onsubmit="return formValidation()" method="post" action="">
                                <div class="row register-form">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                        <input type="email" id="email1" name="email1" class="form-control" placeholder="Email *" value=""  onkeyup="validateEmail()"/>
